//                   version 1.1      Kim Steenstrup Pedersen, DIKU, August 2017, August 2020
//
...
void runEncoderRight()
{
 if (digitalRead(encoderRA) == digitalRead(encoderRB))   
   right_encoder++;    // count up if both encoder pins are HIGH on pin change interrupt
 else                                       
   right_encoder--;    //count down if pins are HIGH and LOW
}
